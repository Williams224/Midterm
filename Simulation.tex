...
The energies chosen for this investigation were 1,2,3,4,5,7,9,12,15,20,25,30 and 40 GeV as these were considered representative of the expected energies at \lhcb. The following configurations were tested with these energies: \geant version 9.5 with the \textit{LHCbOld} PL, version 9.6 with \textit{LHCbNew} PL and verision 9.6 \textit{opt0} PL.  These were chosen because it allows a direct comparison between the old release of \geant and the new release of \geant to be made.  Also, \textit{opt0} was included as it offers a comparison with a non-simplified multiple scattering model.
