...
\subsubsection{Sampling Fraction and Shower Profile Investigations}
...
\subsubsection{Discussion of results for \geant version comparison}
...
\begin{itemize}
\item \textbf {New implementation of UrbanMsc95 multiple scattering model} 
